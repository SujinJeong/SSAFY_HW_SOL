...
public class ProductTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"1: 모든 상품보기, 2: 상품번호로 검색, 3: 상품번호로 삭제, " + "4: 상품 이름으로 검색, 5: TV만 출력, 6: 냉장고만 출력, 7: 전체 재고 상품 금액 구하기, "
		...
		case 10:
			...
			if (pm.updatePrice(input, price)) System.out.println("가격 변경 성공!");
			else System.out.println("상품 번호를 다시 입력하세요");
			break;
		}
